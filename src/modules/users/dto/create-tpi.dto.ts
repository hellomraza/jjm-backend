...
export class CreateTpiDto {
  @ApiProperty({
    description: 'Full name of the TPI officer',
  ...
  @ApiProperty({
    description: 'Unique email address for the TPI officer',
    example: 'tpi.jaipur@jjm.local',
  })
  @IsEmail()
  email: string;
  ...
  @ApiProperty({
    description: 'District code / ID assigned to the TPI officer',
    example: 'DIST001',
  })
  @IsString()
  @IsNotEmpty()
